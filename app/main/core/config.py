...
class ConfigClass(BaseSettings):
    ...
    SQLALCHEMY_DATABASE_URL: str = get_secret("SQLALCHEMY_DATABASE_URL", 'postgresql://postgres:postgre@localhost:5432/rendez_vous_medical')
    ...
    CLOUDINARY_CLOUD_NAME:str = get_secret("CLOUDINARY_NAME","dlmrmr7hp")
    CLOUDINARY_API_KEY:str = get_secret("CLOUDINARY_API_KEY","994233424117489")
    CLOUDINARY_API_SECRET:str = get_secret("CLOUDINARY_API_SECRET","L4fdtGSQJlBJGBFKRi4S0M0Lr4E")
    ...
    MAILTRAP_USERNAME :str = get_secret("MAILTRAP_USERNAME", "fd4eb24447d384")
    MAILTRAP_PASSWORD :str = get_secret("MAILTRAP_PASSWORD", "126d650d5b5eb6")
    MAILTRAP_HOST: ClassVar[str] = "smtp.mailtrap.io"
    MAILTRAP_PORT: ClassVar[int] = 587
    EMAILS_FROM_CLOUDINARY: str = get_secret("EMAILS_FROM_CLOUDINARY", "hamidabdoul707@gmail.com")

    PREFERRED_LANGUAGE: str = get_secret("PREFERRED_LANGUAGE", 'fr')
    API_V1_STR: str = get_secret("API_V1_STR", "/api/v1")
    
    PROJECT_NAME: str = get_secret("PROJECT_NAME", "RENDEZ_VOUS_MEDICAL")
    ...
    EMAILS_FROM_EMAIL: Optional[EmailStr] = get_secret("EMAILS_FROM_EMAIL", "hamidabdoul707@gmail.com")
